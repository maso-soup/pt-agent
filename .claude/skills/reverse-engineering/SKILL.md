...
**[checksec](checksec.md)** (pwntools) — Binary exploit mitigation checker
...
**[rabin2](rabin2.md)** (radare2) — Fast binary metadata extraction
...
**[readelf](readelf.md)** — ELF binary security inspection
...
**[strings](strings.md)** — Embedded credential and artifact extraction
...
**[nm](nm.md)** — Symbol table inspection
...
**[xxd](xxd.md)** — Hex dump and file format identification
...
**[binwalk](binwalk.md)** — Firmware signature scanning and extraction
...
**[objection](objection.md)** — Runtime mobile exploration
