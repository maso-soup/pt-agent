...
**[hydra](hydra.md)** — Multi-protocol online password brute-force
...
**[medusa](medusa.md)** — Parallel multi-protocol brute-force
...
**[patator](patator.md)** — Modular multi-protocol brute-force and fuzzing
...
**[kerbrute](kerbrute.md)** — Kerberos username enumeration and password spraying
...
**[netexec](netexec.md)** — Windows network batch exploitation (CrackMapExec successor)
...
**[brutespray](brutespray.md)** — nmap-driven default credential spraying
...
**[crowbar](crowbar.md)** — RDP/OpenVPN/SSH-key brute-force
...
**[hashcat](hashcat.md)** — GPU-accelerated hash cracking
...
**[john](john.md)** — John the Ripper hash cracking
...
**[cewl](cewl.md)** — Target website custom wordlist
...
**[crunch](crunch.md)** — Rule-based wordlist generation
...
**[hashid](hashid.md)** — Hash type identification
...
**[name-that-hash](name-that-hash.md)** — Modern hash type identifier
...
**[rainbowcrack](rainbowcrack.md)** — Rainbow table hash cracking
...
**[responder](responder.md)** — LLMNR/NBT-NS poisoning and capture
...
**[gpp-decrypt](gpp-decrypt.md)** — Group Policy Preferences password decryption
...
**[fcrackzip](fcrackzip.md)** — ZIP archive password cracker
...
**[pdfcrack](pdfcrack.md)** — PDF password recovery
...
**[changeme](changeme.md)** — Default credential scanner
...
**[chntpw](chntpw.md)** — Offline Windows SAM password reset
