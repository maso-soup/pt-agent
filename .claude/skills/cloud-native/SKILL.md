...
description: Tools for authorized cloud, Kubernetes, container image, container registry, and Docker host security assessment. Use this skill when the scope includes cloud accounts, Kubernetes clusters, deployment manifests, container images, registries, or Docker hosts.
---

# Cloud-Native Security

Tools for authorized cloud, Kubernetes, container image, container registry, and Docker host security assessment. Use this skill when the scope includes cloud accounts, Kubernetes clusters, deployment manifests, container images, registries, or Docker hosts.
...
**[ScoutSuite](scoutsuite.md)** — Multi-cloud security auditing
...
**[Prowler](prowler.md)** — Cloud compliance and security assessment
...
**[azurehound](azurehound.md)** — Azure AD/ARM data collection for BloodHound
...
**[pacu](pacu.md)** — AWS exploitation framework
...
**[docker-bench-security](docker-bench-security.md)** — Docker host CIS-style audit
