...
**[nmap](nmap.md)** — Network scanning and port probing
...
**[masscan](masscan.md)** — Ultra-high-speed port scanning
...
**[naabu](naabu.md)** — Fast pipeline-friendly port scanning
...
**[netdiscover](netdiscover.md)** — Internal network ARP host discovery
...
**[arp-scan](arp-scan.md)** — Fast ARP scanning
...
**[nbtscan](nbtscan.md)** — NetBIOS name table scanning
...
**[fping](fping.md)** — Fast multi-host ICMP ping
...
**[p0f](p0f.md)** — Passive OS fingerprinting
...
**[subfinder](subfinder.md)** — Passive subdomain enumeration
...
**[assetfinder](assetfinder.md)** — Fast passive subdomain discovery
...
**[findomain](findomain.md)** — Fast subdomain discovery (Rust)
...
**[hakrawler](hakrawler.md)** — Fast web crawler for endpoint discovery
...
**[getallurls (gau)](getallurls.md)** — Known URL fetching from historical sources
...
**[httprobe](httprobe.md)** — HTTP/HTTPS liveness probing
...
**[hosthunter](hosthunter.md)** — Virtual hostname discovery via SSL/TLS certificates and Bing reverse IP
...
**[spiderfoot](spiderfoot.md)** — Comprehensive OSINT automation
...
**[autorecon](autorecon.md)** — Automated multi-service enumeration
...
**[amass](amass.md)** — Comprehensive subdomain enumeration
...
**[sublist3r](sublist3r.md)** — Multi-engine subdomain enumeration
...
**[dnsenum](dnsenum.md)** — Automated DNS enumeration
...
**[dnsrecon](dnsrecon.md)** — Multi-mode DNS reconnaissance
...
**[fierce](fierce.md)** — DNS subdomain brute-force enumeration
...
**[dnsmap](dnsmap.md)** — DNS subdomain brute-force
...
**[dig](dig.md) / host / nslookup** — DNS basic query tools
...
**[dnsx](dnsx.md)** — Fast bulk DNS resolution and brute-force
...
**[massdns](massdns.md)** — High-performance bulk DNS resolver
...
**[dnsgen](dnsgen.md)** — DNS permutation generation
...
**[altdns](altdns.md)** — Subdomain permutation and alteration
...
**[dnstwist](dnstwist.md)** — Domain permutation and typosquatting detection
...
**[certgraph](certgraph.md)** — Certificate transparency graph builder
...
**[theHarvester](theHarvester.md)** — Multi-source intelligence collection for emails/domains
...
**[recon-ng](recon-ng.md)** — OSINT framework
...
**[shodan (CLI)](shodan.md)** — Network asset search engine
...
**[whois](whois.md)** — Domain registration information lookup
...
**[dmitry](dmitry.md)** — Comprehensive OSINT collection
...
**[metagoofil](metagoofil.md)** — Public document metadata extraction
...
**[sherlock](sherlock.md)** — Username search across social media
...
**[h8mail](h8mail.md)** — Email OSINT and breach credential search
...
**[ldeep](ldeep.md)** — LDAP deep enumeration for Active Directory
...
**[cloud-enum](cloud-enum.md)** — Multi-cloud public asset enumeration
...
**[cloudbrute](cloudbrute.md)** — Cloud bucket and app endpoint brute-forcing
...
**[shodan (CLI)](shodan.md)** — Cloud and internet-facing asset search
...
**[trufflehog](trufflehog.md)** — Secret scanning for git repos, filesystems, and cloud storage
...
**[macchanger](macchanger.md)** — MAC address randomization
...
**[whatweb](whatweb.md)** — Web fingerprinting
...
**[finalrecon](finalrecon.md)** — All-in-one web reconnaissance
...
**[eyewitness](eyewitness.md)** — Batch web service screenshots
...
**[gowitness](gowitness.md)** — Web service screenshotting
...
**[httpx](httpx.md)** — HTTP service liveness probing
