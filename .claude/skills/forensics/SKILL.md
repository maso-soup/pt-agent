...
**[volatility3](volatility.md)** — Memory image analysis  
...
**[foremost](foremost.md) / [scalpel](scalpel.md)** — File recovery  
...
**[scalpel](scalpel.md)** — Header/footer-based file carving  
...
**[dc3dd](dc3dd.md)** — Forensic disk imaging  
...
**[dcfldd](dcfldd.md)** — Enhanced forensic disk imaging  
...
**[sleuthkit](sleuthkit.md)** — CLI disk forensics toolkit  
...
**[testdisk](testdisk.md)** — Partition recovery and file restoration  
...
**[ddrescue](ddrescue.md)** — Data recovery from damaged media  
...
**[hashdeep](hashdeep.md)** — Recursive multi-algorithm hash computation and audit  
...
**[binwalk](binwalk.md)** — Firmware analysis and extraction  
...
**[tcpdump](tcpdump.md)** — Command-line packet capture  
...
**[tshark](tshark.md)** — Command-line protocol analyzer  
...
**[tcpflow](tcpflow.md)** — TCP stream reassembly  
...
**[exiftool](exiftool.md)** — File metadata extraction  
...
**[steghide](steghide.md)** — Steganography analysis  
...
**[stegseek](stegseek.md)** — Ultra-fast steghide passphrase cracker  
...
**[chainsaw](chainsaw.md)** — Windows event log threat hunting  
...
**[regripper](regripper.md)** — Windows Registry hive analysis  
...
**[bulk-extractor](bulk-extractor.md)** — Raw forensic artifact extraction  
...
**[yara](yara.md)** — Pattern-based malware identification  
...
**[chkrootkit](chkrootkit.md)** — Rootkit detection for Unix/Linux  
...
**[rkhunter](rkhunter.md)** — Rootkit Hunter  
...
**[ssdeep](ssdeep.md)** — Fuzzy hashing for file similarity detection  
...
For evidence handling procedures and timeline construction methodology, see [forensics-triage playbook](forensics-triage.md).

**[plaso](plaso.md)** — Super-timeline generation engine  
